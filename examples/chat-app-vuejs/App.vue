...
export default class App extends Vue {
      ...
      pipe(
        ...
        async (source) => {
          for await (const msg of source) {
            console.log('incoming messages: ', msg);
  ...
  sendMessage() {
    ...
    console.log('sendinng message: ', this.chatMessage);
